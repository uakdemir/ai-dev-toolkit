...
3. Load the filtered checklist files. If a checklist file referenced in `index.md` does not exist on disk, skip it with a note: "Checklist `<file>` listed in index but not found. Skipping."
